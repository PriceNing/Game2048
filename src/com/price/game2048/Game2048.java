...
public class Game2048 extends JFrame{
	...
	public Game2048(){
		...
		try
		{
			Image img=ImageIO.read(this.getClass().getResource("/image/icon2.png"));
		...
		scoresPane.setBorder(BorderFactory.createMatteBorder(2, 2, 2, 2, Color.CYAN));	//设置得分面板的边框
